// To parse this data:
//
//   import { Convert, PokemonAPIResponse } from "./file";
//
...
export class Convert {
    public static toPokemonAPIResponse(json: string): PokemonAPIResponse {
        return cast(JSON.parse(json), r("PokemonAPIResponse"));
    }

    public static pokemonAPIResponseToJson(value: PokemonAPIResponse): string {
        return JSON.stringify(uncast(value, r("PokemonAPIResponse")), null, 2);
    }
}
